...
3. Si aplica: `update_prices.sql`, `seed_pae.sql`, **`send_requests.sql`** (botón Probar envío), **`period_selection.sql`** (rango de noticias configurable) y **`period_include_send_day.sql`** (que el rango llegue hasta el día del envío)
